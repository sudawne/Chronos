                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-wrap gap-1 max-w-[250px]">
                                @forelse($u->getDirectPermissions() as $perm)
                                    <span class="px-2 py-1 bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400 text-[11px] font-bold rounded-md border border-indigo-100">{{ $perm->name }}</span>
                                @empty
